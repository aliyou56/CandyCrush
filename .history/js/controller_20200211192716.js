...
class Controller {
    ...
    click(x_, y_) {
        ...
        let x = Math.floor(x_ / this.view.spriteSize)
        let y = Math.floor(y_ / this.view.spriteSize)  
        if(this.isFirstClick) { // first selection 
            ...
            console.log("second click: lx=",this.selectedPosition.x , " ly=", this.selectedPosition.y, " x=",x, " y=",y)
   ...
   gameEventHandler(context_) {
        ...
        if(this.model.isAlignmentExist()) {
            ...
            // shrink anim
            this.view.shrink(spriteToBeRemoved)
