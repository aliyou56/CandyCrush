...
class Sprite {
    ...
    update() {
        ...
        if(this.pageX != this.toPageX) {
            this.pageX = (this.pageX < this.toPageX) ? this.pageX+offset : this.pageX-offset
        }
        if(this.pageY != this.toPageY) {
            this.pageY = (this.pageY < this.toPageY) ? this.pageY+offset : this.pageY-offset
        }
    }
