...
class Sprite {
    ...
    draw(context) {
        ...
        img.onload = function() {
            if(that.isSelected) {
                ...
                context.drawImage(img, that.pageX, that.pageY, that.width, that.height);
            }
        }
    ...
    getImagePath() {
        ...
        console.log("getImagePath -> obj="+this.obj+", result="+result)
        return result + ".png"
    }
...
class View {
    ...
    drawAll(context) {
        ...
        this.board[0][0].draw(context)
        this.board[4][0].draw(context)
