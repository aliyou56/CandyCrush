...
class View {
    ...
    animate(context) {
        ...
        if(this.isMoving()) {
            setTimeout(() => {that.animate(context)}, 2)
        }
    }
    ...
    drawAll(context) {
        ...
        var width = document.getElementById("canvas").getContext("2d").width
        var height = document.getElementById("canvas").getContext("2d").height
